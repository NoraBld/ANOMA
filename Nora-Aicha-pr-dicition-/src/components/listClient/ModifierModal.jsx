...
//     try {
//       // Envoi du fichier si présent
//       if (selectedType && selectedFile) {
//         const formData = new FormData();
//         formData.append("file", selectedFile);
//         formData.append("type", selectedType);

//         const uploadRes = await fetch("http://localhost:8000/import-clients", {
//           method: "POST",
//           body: formData,
//         });
...
//           setErrors({ global: errorData.detail || "Erreur lors de l'import du fichier." });
//           return;
//         }
//       }

//       // Mise à jour du client existant
//       const res = await fetch(`http://localhost:8000/clients/${clientToEdit.id}`, {
//         method: "PUT",
...
//         setErrors({ global: errorData.detail || "Erreur inconnue" });
//         return;
//       }
