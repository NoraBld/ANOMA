...
import PredictionTable from "../components/profilComponent/PredictionTable";
  ...
  return (
    <div className="flex w-full h-screen overflow-hidden" style={{ backgroundColor: '#E5E5E5' }}>
      ...
      <div className="flex-1 h-full overflow-y-auto p-6" style={{ backgroundColor: '#E5E5E5' }}>
        <div className="max-w-6xl mx-auto rounded-xl shadow-md p-6 bg-white border-2 border-[#1D2D66]">

          <div className="flex justify-between items-center mb-6">
            <div className="text-lg font-bold text-[#162556]">{adminData.nom_Entreprise}</div>
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div key={name} className="flex flex-col">
                ...
                <div className="flex items-center space-x-2">
                  {editableFields[name] ? (
                    ...
                    <>
                      <span className={inputClass}>{adminData[name]}</span>
            ...
            <div className="flex flex-col md:col-span-2">
              ...
              {editableFields.mot_de_passe ? (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                  <input type="password" name="current" placeholder="Mot de passe actuel" value={passwords.current} onChange={handleChange} className={inputClass} />
                  <input type="password" name="new" placeholder="Nouveau mot de passe" value={passwords.new} onChange={handleChange} className={inputClass} />
                  <input type="password" name="confirm" placeholder="Confirmer le mot de passe" value={passwords.confirm} onChange={handleChange} className={inputClass} />
                </div>
              ) : (
                <div className="flex items-center space-x-2">
            ...
            <div className="md:col-span-2 mt-6 p-4 bg-white rounded-xl">
